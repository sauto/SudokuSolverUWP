...
namespace SudokuSolver
{
    public class Solver// : ISolver
    {
        ...
        /// 使ったロジックの表示可否
        /// </summary>
        public bool DisplayUsedLogic { set { displayUsedLogic = value; } }
        bool displayUsedLogic = true;
                    ...
                    if (i != r)
                    {
                        for (int bit = 2; bit < (int)Math.Pow(2, 10); bit <<= 1)
                        {
                            ...
                            if (sameCandCheck == 2)
                            {
                                ...
                                if ((col1CandCount == 2) && (col2CandCount == 2))
                                {
                                    ...
                                    {
                                        if (displayUsedLogic)
                                            Console.WriteLine("対角行{0}行,{1}行", i, r);
                        ...
                        if ((sameCandCheck == 2) && (spacecountA == 2) && (spacecountB == 2))
                        {
                            ...
                            if (c == 1 || c == 2)
                            {
                                ...
                                {
                                    if (displayUsedLogic)
                                        Console.WriteLine("対角行確定数字版{0}行,{1}行", i, r);
                    ...
                    if (j != c)
                    {
                        for (int bit = 2; bit < (int)Math.Pow(2, 10); bit <<= 1)
                        {
                            ...
                            if (sameCandCheck == 2)
                            {
                                ...
                                if ((row1check == 2) && (row2check == 2))
                                {
                                    ...
                                    {
                                        if (displayUsedLogic)
                                            Console.WriteLine("対角列{0}行,{1}行", j, c);
                        ...
                        if ((sameCandCheck == 2) && (spacecountA == 2) && (spacecountB == 2))
                        {
                            ...
                            if (count == 1 || count == 2)
                            {
                                ...
                                {
                                    if (displayUsedLogic)
                                        Console.WriteLine("対角列確定数字版{0}行,{1}行\n", j, c);
                ...
                for (int j = 0; j < Utility.COL; j++)
                {
                    ...
                    if (Utility.GetOnBitList(candMat[i][j], 10).Count == 3)
                    {
                        ...
                        if (tripleCondMatchCount == 2)
                        {
                            ...
                            {
                                if (displayUsedLogic)
                                    Console.WriteLine("独立三つ子行333({0},{1}),({2},{3}),({4},{5})", i, j, i, tripleCondMatchColA, i, tripleCondMatchColB);
                    ...
                    if (Utility.GetOnBitList(candMat[i][j], 10).Count == 2)
                    {
                        ...
                        if (tripleCondMatchCount == 2)
                        {
                            ...
                            {
                                if (displayUsedLogic)
                                    Console.WriteLine("独立三つ子行222({0},{1}),({2},{3}),({4},{5})", i, j, i, tripleCondMatchColA, i, tripleCondMatchColB);
                    ...
                    if (Utility.GetOnBitList(candMat[i][j], 10).Count == 3)
                    {
                        ...
                        {//3個の候補数字が3マスで一致したら
                         //処理前盤面記憶
                            ...
                            {
                                if (displayUsedLogic)
                                    Console.WriteLine("独立三つ子列333({0},{1}),({2},{3}),({4},{5})", i, j, i, tripleCondMatchRowA, i, tripleCondMatchRowB);
                    ...
                    {//その1マスで2個しか候補数字がなかったら 222
                        ...
                        {//222を満たしたら
                         //処理前盤面記憶
                            ...
                            {
                                if (displayUsedLogic)
                                    Console.WriteLine("独立三つ子列222({0},{1}),({2},{3}),({4},{5})", i, j, i, tripleCondMatchRowA, i, tripleCondMatchRowB);
                            ...
                            if (Utility.GetOnBitList(candMat[p][q], 10).Count == 3)
                            {
                                ...
                                {//3個の候補数字が3マスで一致したら
                                 //処理前盤面記憶
                                    ...
                                    {
                                        if (displayUsedLogic)
                                            Console.WriteLine("独立三つ子ブロック333({0},{1}),({2},{3}),({4},{5})",
                                        ...
                                        if (Utility.GetOnBitList((candMemory & candMat[i][m]), 10).Count >= 2)
                                        {
                                            ...
                                            if (Utility.GetOnBitList(candMemory, 10).Count == 3)
                                            {
                                                ...
                                                if (Utility.GetOnBitList((candMat[i][m] & candMemory), 10).Count >= 2)
                                                {
                                                    ...
                                                    {
                                                        if (displayUsedLogic)
                                                            Console.WriteLine("居候三つ子行333({0},{1}),({2},{3}),({4},{5})", i, j, i, k, i, m);
                                            ...
                                            if ((m != j) && (m != k))
                                            {
                                                ...
                                                if (Utility.GetOnBitList((candMemoryTri & candMat[i][m]), 10).Count >= 2)
                                                {
                                                    ...
                                                    if ((Utility.GetOnBitList(candMemory, 10).Count == 3) && (candMemory == candMemoryTri))
                                                    {
                                                        ...
                                                        {
                                                            if (displayUsedLogic)
                                                                Console.WriteLine("居候三つ子行222({0},{1}),({2},{3}),({4},{5})", i, j, i, k, i, m);
                                        ...
                                        if (Utility.GetOnBitList((candMemory & candMat[m][j]), 10).Count >= 2)
                                        {
                                            ...
                                            if (Utility.GetOnBitList(candMemory, 10).Count == 3)
                                            {
                                                if (Utility.GetOnBitList((candMat[m][j] & candMemory), 10).Count >= 2)
                                                {
                                                    ...
                                                    {
                                                        if (displayUsedLogic)
                                                            Console.WriteLine("居候三つ子列333({0},{1}),({2},{3}),({4},{5})", i, j, k, j, m, j);
                                            ...
                                            if ((m != i) && (m != k))
                                            {
                                                ...
                                                if (Utility.GetOnBitList((candMemoryTri & candMat[m][j]), 10).Count >= 2)
                                                {
                                                    ...
                                                    if ((Utility.GetOnBitList(candMemory, 10).Count == 3) && (candMemory == candMemoryTri))
                                                    {
                                                        ...
                                                        {
                                                            if (displayUsedLogic)
                                                                Console.WriteLine("居候三つ子列222({0},{1}),({2},{3}),({4},{5})", i, j, k, j, m, j);
                                                        ...
                                                        if (Utility.GetOnBitList((candMat[u][w] & candMemory), 10).Count >= 2)
                                                        {
                                                            ...
                                                            if (Utility.GetOnBitList(candMemory, 10).Count == 3)
                                                            {
                                                                ...
                                                                if (Utility.GetOnBitList((candMat[u][w] & candMemory), 10).Count >= 2)
                                                                {
                                                                    ...
                                                                    {
                                                                        if (displayUsedLogic)
                                                                            Console.WriteLine("居候三つ子ブロック333({0},{1}),({2},{3}),({4},{5})", p, q, s, t, u, w);
                                                                        DoSingleLogics(mat, candMat);
                                                                        return;
                                                                    }
                                                                }
                                                            ...
                                                            if (!((u == p) && (w == q)) && !((u == s) && (w == t)))
                                                            {
                                                                ...
                                                                if (Utility.GetOnBitList((candMemoryTri & candMat[u][w]), 10).Count >= 2)
                                                                {
                                                                    ...
                                                                    if ((Utility.GetOnBitList(candMemory, 10).Count == 3) && (candMemory == candMemoryTri))
                                                                    {
                                                                        ...
                                                                        {
                                                                            if (displayUsedLogic)
                                                                                Console.WriteLine("居候三つ子ブロック222({0},{1}),({2},{3}),({4},{5})", p, q, s, t, u, w);
                                                                            DoSingleLogics(mat, candMat);
                                                                            return;
                                                                        }																				
                                                                    }
                                ...
                                if (candHit9Cell == candHit3Cell)
                                {
                                    ...
                                    for (int u = blockPoint.X; u <= blockPoint.X + 2; u++)
                                    {
                                        for (int w = blockPoint.Y; w <= blockPoint.Y + 2; w++)
                                        {
                                            ...
                                            {
                                                if (displayUsedLogic)
                                                    Console.WriteLine("共有行→ブロック({0},{1})", i, m);
                                ...
                                if (candHit9Cell == candHit3Cell)
                                {
                                    ...
                                    for (int u = blockPoint.X; u <= blockPoint.X + 2; u++)
                                    {
                                        for (int w = blockPoint.Y; w <= blockPoint.Y + 2; w++)
                                        {
                                            ...
                                            {
                                                if (displayUsedLogic)
                                                    Console.WriteLine("共有列→ブロック({0},{1})", m, j);
                            ...
                            if (blankCheck > 1)
                            {
                                ...
                                if (candHit3Cell > 1)
                                {
                                    ...
                                    if (candHit9Cell == candHit3Cell)
                                    {
                                        ...
                                        {
                                            if (displayUsedLogic)
                                                Console.WriteLine("共有ブロック→行({0},{1})", i, j);
                            ...
                            if (blankCheck > 1)
                            {
                                ...
                                if (candHit3Cell > 1)
                                {
                                    ...
                                    if (candHit9Cell == candHit3Cell)
                                    {
                                        ...
                                        {
                                            if (displayUsedLogic)
                                                Console.WriteLine("共有ブロック→列({0},{1})", i, j);
                    ...
                    if (Utility.GetOnBitList(candMat[i][j], 10).Count == 2)
                    {
                        ...
                        for (int m = 0; m < Utility.COL; m++)
                        {
                            ...
                            if ((m != j) && (candMat[i][m] == candMat[i][j]))
                            {
                                ...
                                {
                                    if (displayUsedLogic)
                                        Console.WriteLine("独立双子行({0},{1}),({2},{3})", i, j, i, m);
                    ...
                    if (Utility.GetOnBitList(candMat[i][j], 10).Count == 2)
                    {
                        ...
                        for (int m = 0; m < Utility.ROW; m++)
                        {
                            ...
                            if ((m != i) && (candMat[m][j] == candMat[i][j]))
                            {
                                ...
                                {
                                    if (displayUsedLogic)
                                        Console.WriteLine("独立双子列({0},{1}),({2},{3})", i, j, m, j);
                                ...
                                for (int s = i; s <= i + 2; s++)
                                    for (int t = j; t <= j + 2; t++)
                                        ...
                                        if (!((s == p) && (t == q)) && (candMat[s][t] == candMat[p][q]))
                                        {
                                            ...
                                            {
                                                if (displayUsedLogic)
                                                    Console.WriteLine("独立双子ブロック({0},{1}),({2},{3})", p, q, s, t);
                                ...
                                if (j != k)
                                {
                                    ...
                                    if (candmemory > 0)
                                    {
                                        ...
                                        if (Utility.GetOnBitList(candmemory, 10).Count == 2)
                                        {
                                            ...
                                            {
                                                if (displayUsedLogic)
                                                    Console.WriteLine("居候双子行({0},{1}),({2},{3})", i, j, i, k);
                                ...
                                if (i != k)
                                {
                                    ...
                                    if (candmemory > 0)
                                    {
                                        ...
                                        if (Utility.GetOnBitList(candmemory, 10).Count == 2)
                                        {
                                            ...
                                            {
                                                if (displayUsedLogic)
                                                    Console.WriteLine("居候双子列({0},{1}),({2},{3})", i, j, k,j);
                                            ...
                                            if (!((s == p) && (t == q)))
                                            {
                                                ...
                                                if (candmemory > 0)
                                                {
                                                    ...
                                                    if (Utility.GetOnBitList(candmemory, 10).Count == 2)
                                                    {
                                                        ...
                                                        {
                                                            if (displayUsedLogic)
                                                                Console.WriteLine("居候双子ブロック({0},{1}),({2},{3})", p, q, s, t);
